...
public enum DateConstants {
    static public let locale = "en_US_POSIX"
}
...
public var localePOSIX: Locale {
    Locale(identifier: DateConstants.locale)
}

public var formatterUTC: DateFormatter? {
...
extension DateFormatter {
    ...
    static public func formatter(with dateFormat: DateFormat = .defaultFormat,
    ...
    static public func findDifference(from startDate: Date,
                               to endDate: Date,
